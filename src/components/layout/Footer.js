            ...
            <div className="row">
                <div className="col-md-12">
                    <div className="footer p-3 mt-4 text-center bg-dark text-light">
                        ...
                        , using <a className="text-success" target="blank" rel="noopener noreferrer" href="https://covid19-india-adhikansh.herokuapp.com/">Covid-19 INDIA API</a> in collaboration with <a className="text-danger" target="blank" rel="noopener noreferrer" href="https://github.com/HrithikMittal">Adhikansh Mittal</a> for project work.
