        ...
        return(
            ...
            >
                <Layer type="circle" id="marker" paint={{
                    ...
                    <Feature coordinates={[79.7400, 15.9129]} onClick={() => {this.display('Andhra%20Pradesh'); window.scrollTo(0,500);}}/>
                    <Feature coordinates={[92.6586, 11.7401]} onClick={() => {this.display('Andaman%20and%20Nicobar%20Islands'); window.scrollTo(0,500);}}/>
                    <Feature coordinates={[94.7278, 28.2180]} onClick={() => {this.display('Arunachal%20Pradesh'); window.scrollTo(0,500);}}/>
                    ...
                    <Feature coordinates={[77.1734, 31.1048]} onClick={() => {this.display('Himachal%20Pradesh'); window.scrollTo(0,500);}}/>
                    <Feature coordinates={[76.5762, 33.7782]} onClick={() => {this.display('Jammu%20and%20Kashmir'); window.scrollTo(0,500);}}/>
                    ...
                    <Feature coordinates={[78.6569, 22.9734]} onClick={() => {this.display('Madhya%20Pradesh'); window.scrollTo(0,500);}}/>
                    ...
                    <Feature coordinates={[87.8550, 22.9868]} onClick={() => {this.display('West%20Bengal'); window.scrollTo(0,500);}}/>
                </Layer>
            </Map>   
        );
    }
